...
scheduler.register(TCEPESource())         # 24h
scheduler.register(TCEAMSource())         # 24h
scheduler.register(TCEPBSource())         # 24h
scheduler.register(TCESESource())         # 6h
scheduler.register(TCEPISource())         # 24h
